...
class XCUITestDriver extends driver_1.BaseDriver {
    ...
    constructor(opts = /** @type {XCUITestDriverOpts} */ ({}), shouldValidateCaps = true) {
        ...
        /*---------+
         | GESTURE |
         +---------+*/
        this.moveTo = commands_1.default.gestureExtensions.moveTo;
        ...
        this.applyMoveToOffset = commands_1.default.gestureExtensions.applyMoveToOffset;
        /*-------+
         | IOHID |
         +-------+*/
        ...
        this.getNativePageSource = commands_1.default.sourceExtensions.getNativePageSource;
        ...
        this.clickCoords = commands_1.default.webExtensions.clickCoords;
        /*--------+
         | XCTEST |
         +--------+*/
        ...
        this.webElementsCache = new lru_cache_1.default({
    ...
    async getStatus() {
        if (typeof this.driverInfo === 'undefined') {
            this.driverInfo = await (0, utils_1.getDriverInfo)();
        }
    ...
    getDefaultUrl() {
        ...
        return this.isRealDevice()
            ...
            : `http://${this.opts.address.includes(':') ? `[${this.opts.address}]` : this.opts.address}:${this.opts.port}/welcome`;
    }
    async start() {
        ...
        if (support_1.util.compareVersions(this.opts.platformVersion, '<', '9.3')) {
        ...
        if (this.isSimulator()) {
            if (this.opts.shutdownOtherSimulators) {
                ...
                // @ts-expect-error - do not assign arbitrary properties to `this.opts`
                await (0, simulator_management_1.shutdownOtherSimulators)(this.opts.device);
            }
            await this.startSim();
            ...
            // @ts-expect-error - do not assign arbitrary properties to `this.opts`
            if (await (0, simulator_management_1.setSafariPrefs)(this.opts.device, this.opts)) {
                this.log.debug('Safari preferences have been updated');
            }
            // @ts-expect-error - do not assign arbitrary properties to `this.opts`
            if (await (0, simulator_management_1.setLocalizationPrefs)(this.opts.device, this.opts)) {
                this.log.debug('Localization preferences have been updated');
            }
            if (lodash_1.default.isBoolean(this.opts.reduceMotion)) {
            ...
            if (lodash_1.default.isBoolean(this.opts.reduceTransparency)) {
            ...
            if (this.opts.launchWithIDB) {
                try {
                    const idb = new appium_idb_1.default({ udid });
                    await idb.connect();
                    // @ts-expect-error - do not assign arbitrary properties to `this.opts`
    ...
    async getSession() {
        ...
        const shouldGetDeviceCaps = lodash_1.default.isBoolean(this.opts.includeDeviceCapsToSessionInfo)
        ...
        return Object.assign({ udid: this.opts.udid }, driverSession, this.wdaCaps.capabilities, this.deviceCaps || {});
    }
    /**
