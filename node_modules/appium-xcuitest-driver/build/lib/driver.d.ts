...
export class XCUITestDriver extends BaseDriver<{
...
}, import("@appium/types").StringRecord<any>, import("@appium/types").StringRecord<any>, import("@appium/types").StringRecord<any>> implements ExternalDriver<XCUITestDriverConstraints, FullContext | string> {
    static newMethodMap: {
    ...
    wdaCaps: WDACapabilities | undefined;
    ...
    getSession(): Promise<{
        udid: any;
    } & import("@appium/types").ConstraintsToCaps<{
        readonly platformName: {
            readonly presence: true;
            readonly isString: true;
        };
    ...
    }> & import("@appium/types").StringRecord<any>>;
    deviceCaps: {
        pixelRatio: number;
        statBarHeight: number;
        viewportRect: import("./commands/types").Viewport;
    } | undefined;
    ...
    mobileInstallApp: (this: XCUITestDriver, app: string, timeoutMs?: number | undefined, strategy?: import("./commands/types").AppInstallStrategy | undefined) => Promise<void>;
    ...
    activateApp: (this: XCUITestDriver, bundleId: string, opts?: any, ...args: any[]) => Promise<void>;
    ...
    performTouch: (this: XCUITestDriver, gestures: any[]) => Promise<unknown>;
    performMultiAction: (this: XCUITestDriver, actions: any[]) => Promise<unknown>;
    ...
    mobileSwipe: (this: XCUITestDriver, direction: import("./commands/types").Direction, velocity?: number | undefined, elementId?: string | import("@appium/types").Element<string> | undefined) => Promise<unknown>;
    ...
    mobileTouchAndHold: (this: XCUITestDriver, duration: number, x?: number | undefined, y?: number | undefined, elementId?: string | import("@appium/types").Element<string> | undefined) => Promise<unknown>;
    ...
    mobileTapWithNumberOfTaps: (this: XCUITestDriver, elementId: string | import("@appium/types").Element<string>, numberOfTaps: number, numberOfTouches: number) => Promise<void>;
    ...
    mobileRotateElement: (this: XCUITestDriver, elementId: string | import("@appium/types").Element<string>, rotation: number, velocity: number) => Promise<void>;
    ...
    mobilePushNotification: (this: XCUITestDriver, bundleId: string, payload: import("./commands/types").PushPayload) => Promise<any>;
    ...
    mobileGetPermission: (this: XCUITestDriver, bundleId: string, service: import("./commands/enum").PermissionService) => Promise<PermissionState>;
    mobileSetPermissions: (this: XCUITestDriver, access: Record<Partial<import("./commands/types").AccessRule>, PermissionState>, bundleId: string) => Promise<void>;
    ...
    getNativePageSource: (this: XCUITestDriver) => Promise<string>;
