declare namespace _default {
     ...
     * @this {XCUITestDriver}
     */
    function mobileResetPermission(this: import("../driver").default, service: number): Promise<void>;
    /**
     ...
     */
    function mobileGetPermission(this: import("../driver").default, bundleId: string, service: PermissionService): Promise<PermissionState>;
    /**
     ...
     * @this {XCUITestDriver}
     */
    function mobileSetPermissions(this: import("../driver").default, access: Record<Partial<import("./types").AccessRule>, PermissionState>, bundleId: string): Promise<void>;
}
