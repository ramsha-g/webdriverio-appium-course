...
exports.default = {
    ...
    async mobileLaunchApp(bundleId, args, environment) {
        ...
        if (args) {
            launchOptions.arguments = lodash_1.default.isArray(args) ? args : [args];
        }
        if (environment) {
    ...
    async mobileListApps(applicationType = 'User') {
        ...
        const service = await appium_ios_device_1.services.startInstallationProxyService(this.opts.device.udid);
        try {
