...
export function detectUdid(): Promise<any>;
/**
...
export function getAndCheckIosSdkVersion(): Promise<string | null | undefined>;
export function checkAppPresent(app: any): Promise<void>;
export function getDriverInfo(): Promise<{
    built: number;
    version: string;
}>;
export function clearSystemFiles(wda: any): Promise<void>;
export function translateDeviceName(platformVersion: any, deviceName: any): any;
...
export function clearLogs(locations: any): Promise<void>;
/**
