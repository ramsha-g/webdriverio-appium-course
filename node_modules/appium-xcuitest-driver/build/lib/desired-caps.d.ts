...
export namespace desiredCapConstraints {
    namespace platformName {
        const presence: true;
        const isString: true;
        const inclusionCaseInsensitive: readonly ["iOS", "tvOS"];
    }
